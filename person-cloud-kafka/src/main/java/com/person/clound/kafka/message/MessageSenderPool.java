...
import com.person.clound.kafka.domains.ZkHosts;
import com.person.clound.kafka.utils.DynamicBrokersReader;
...
public class MessageSenderPool {
	...
	public MessageSenderPool(int size, String topic, ZkHosts zkhosts, Properties props) {
		...
		DynamicBrokersReader reader = new DynamicBrokersReader(conf, zkhosts.getBrokerZkStr(),
				zkhosts.getBrokerZkPath(), topic);
	 ...
	 * 
	 * @param waitTimeMillis how long should it wait for getting the sender instance
