package com.person.clound.kafka.utils;
...
public class DynamicBrokersReader {
	...
	public DynamicBrokersReader(@SuppressWarnings("rawtypes") Map conf, String zkStr, String zkPath, String topic) {
		_zkPath = zkPath;
		_topic = topic;
		_curator = CuratorFrameworkFactory.newClient(zkStr, new RetryNTimes(Integer.MAX_VALUE, INTERVAL_IN_MS));
		_curator.start();
	}
