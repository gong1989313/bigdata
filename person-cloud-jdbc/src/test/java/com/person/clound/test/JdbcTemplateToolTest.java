...
import com.person.clound.test.model.Student;
...
public class JdbcTemplateToolTest extends AbstractJUnit4SpringContextTests {
	...
	public void testList() throws IOException, SQLException {
		...
		List<Employee> es = jtt.list("select * from employee where age < ? order by id desc", new Object[] { 30 },
				Employee.class);
	...
	@Test
	public void testGet()
			throws NoIdAnnotationFoundException, NoColumnAnnotationFoundException, IOException, SQLException {
		build();
		JdbcTemplateTool jtt = super.applicationContext.getBean("jdbcTemplateTool", JdbcTemplateTool.class);
