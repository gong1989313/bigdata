...
public final class KafkaMessageProducerBak {

	private static final Logger LOGGER = LoggerFactory.getLogger(KafkaMessageProducerBak.class);
	...
	private KafkaMessageProducerBak() {

	}

	private static class LazyHandler {
		private static final KafkaMessageProducerBak instance = new KafkaMessageProducerBak();
	}
	 ...
	 * @return
	 */
	public static final KafkaMessageProducerBak getInstance() {
